document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            bio_p1: "Ben Furkan YAVUZ. 2004 yılında Zonguldak’ın Çaycuma ilçesinde doğdum. Lise eğitimimi Zonguldak’ta tamamladıktan sonra üniversite eğitimi için İzmir’e yerleştim ve şu an İzmir Katip Çelebi Üniversitesi'nde Orman Endüstri Mühendisliği lisans sürecime devam ediyorum. Bu süreci sadece akademik bir yolculuk olarak değil; bitmek bilmeyen bir öğrenme tutkusu ve girişimcilik serüveni olarak tanımlıyorum. 4 yıllık öğrencilik hayatım boyunca, sınırları zorlayan pek çok farklı disiplinde kendimi denemekten ve yeni alanlara atılmaktan asla çekinmedim. Yazılımdan finansal analizlere, e-ticaret operasyonlarından TÜBİTAK 2209-A projelerine kadar uzanan bu süreçte; sayısız girişimde aktif rol aldım.",
            ...
            date_present: "Mart 2021 – Hâlen",
            proj_ops_desc: "Lisans, yazılım ve fiziksel ürünlerin tedarik, satış ve satış sonrası destek süreçlerini yürütüyorum. Ödeme sistemleri entegrasyonu ve müşteri deneyimi süreçlerini bireysel olarak yönetmekteyim.",
            ...
            proj_bot_desc: "Node.js kullanarak 500.000’den fazla kullanıcıya hizmet veren Discord botları geliştirdim. Ayrıca, üçüncü kişilere özel botlar tasarlayarak ticari satış operasyonlarını yönettim.",
        ...
        en: {
            ...
            bio_p1: "I am Furkan YAVUZ. I was born in 2004 in Zonguldak, Çaycuma. After completing my high school education in Zonguldak, I moved to Izmir for university, and I am currently pursuing my bachelor's degree in Forest Industrial Engineering at Izmir Katip Celebi University. I define this process not just as an academic journey, but as an endless passion for learning and an entrepreneurial adventure. Throughout my 4-year student life, I have never hesitated to test myself in various disciplines and venture into new fields. From software to financial analysis, e-commerce operations to TUBITAK 2209-A projects; I managed projects reaching over 500.000 users and took active roles in numerous ventures.",
            tag_counter_500k: "500,000",
            ...
            date_present: "March 2021 – Present",
            proj_ops_desc: "I manage procurement, sales, and post-sales support for license, software, and physical products. I individually handle payment integration and customer experience processes.",
            ...
            proj_bot_desc: "I developed Discord bots serving more than 500,000 users using Node.js. Also, I managed commercial sales for custom third-party bot designs.",
